  ...
  songs: [
    {
      name: "Nụ hôn bisou",
      singer: "Mikelodic",
      path: "./musics/nuhonbisou.mp3",
      image: "./images/nuhonbisou.png",
    },
    {
      name: "3000",
      singer: "Stephanie Poetri",
      path: "./musics/3000.mp3",
      image: "./images/3000.png",
    },
    {
      name: "Buông đôi tay nhau ra",
      singer: "Sơn Tùng MTP",
      path: "./musics/buongdoitaynhaura.mp3",
      image: "./images/buongdoitaynhaura.png",
    },
    {
      name: "Có chàng trai viết lên cây",
      singer: "Phan Mạnh Quỳnh",
      path: "./musics/cochangtraivietlencay.mp3",
      image: "./images/cochangtraivietlencay.png",
    },
    {
      name: "Cung đường lẻ loi",
      singer: "Mikelodic",
      path: "./musics/cungduongleloi.mp3",
      image: "./images/cungduongleloi.png",
    },
    {
      name: "Cupid",
      singer: "FIFTY FIFTY",
      path: "./musics/cupid.mp3",
      image: "./images/cupid.png",
    },
    {
      name: "Lan man",
      singer: "Ronboogz",
      path: "./musics/lanman.mp3",
      image: "./images/lanman.png",
    },
    {
      name: "Tình yêu quá là điên rồ",
      singer: "Liu Grace & Wavy",
      path: "./musics/tinhyeuqualadienro.mp3",
      image: "./images/tinhyeuqualadienro.png",
    },
    {
      name: "Anh đến từ đâu?",
      singer: "Mikelodic",
